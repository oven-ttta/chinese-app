      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col lg:flex-row flex-wrap items-start lg:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap gap-4 w-full lg:w-auto flex-1">
            <div className="w-full sm:w-auto flex-1 flex flex-col sm:flex-row items-start sm:items-center gap-2">
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-semibold text-slate-700 outline-none transition-all cursor-pointer"
              >
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4 bg-indigo-50 p-4 rounded-2xl border border-indigo-100">
          <div className="flex items-center gap-3">
            ...
            <button onClick={selectAll} className="text-sm text-indigo-600 hover:text-indigo-800 font-semibold underline-offset-4 hover:underline">เลือกทั้งหมด</button>
